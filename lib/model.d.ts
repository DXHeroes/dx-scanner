...
export interface PracticeMetadata {
    ...
    dependsOn?: {
        [key in PracticeEvaluationResult]?: string[];
    };
}
export declare enum PracticeImpact {
    high = "high",
    medium = "medium",
    small = "small",
    hint = "hint",
...
export declare enum PracticeEvaluationResult {
...
export declare enum E2ETestFramework {
...
export declare enum IntegrationTestFramework {
    newman = "newman",
    pact = "pact",
    UNKNOWN = "UNKNOWN"
}
export interface PackageManagement {
    ...
    hasLockfile: boolean;
    packages: {
        [packageName: string]: PackageDependency;
    };
}
...
export declare enum PackageManagementFramework {
    Bundler = "Bundler",
    NPM = "NPM",
    Yarn = "Yarn",
    Cocoapods = "Cocoapods",
...
export declare enum ProjectComponentFramework {
...
export declare enum ProjectComponentPlatform {
    BackEnd = "BackEnd",
    FrontEnd = "FrontEnd",
    iOS = "iOS",
    Android = "Android",
...
export declare enum ProjectComponentType {
    Application = "Application",
    Library = "Library",
    Documentation = "Documentation",
    UNKNOWN = "UNKNOWN"
}
export declare enum GitFLow {
    UNKNOWN = "UNKNOWN",
    Github = "Github",
    Git = "Git"
}
export declare type VCSService = GitHubService | BitbucketService | GitLabService;
