...
exports.PullRequest = exports.PullRequestItem = exports.BranchItem = exports.ContributorsStats = exports.Contributor = exports.UserItem = exports.DirectoryItem = exports.File = exports.FileItem = exports.Repository = exports.GitHubNock = void 0;
...
class GitHubNock {
    ...
    getContributorsStats(contributors, persist = true) {
...
class ContributorsStats {
    constructor(author, total) {
        this.weeks = [];
        this.author = author;
        this.total = total;
    }
}
exports.ContributorsStats = ContributorsStats;
class BranchItem {
