...
const listContributorsResponseFactory_1 = require("../factories/responses/gitLab/listContributorsResponseFactory");
class GitLabNock {
    ...
    listContributors(statusCode, contributor, hasNextPage = false, options) {
        var _a, _b, _c, _d;
        const encodedProjectUrl = encodeURIComponent(`${this.user}/${this.repoName}`);
        ...
        const response = [listContributorsResponseFactory_1.gitLabListContributorsResponseFactory(contributor)];
