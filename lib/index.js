...
exports.ProjectComponentType = exports.ProjectComponentPlatform = exports.ProjectComponentFramework = exports.ProgrammingLanguage = exports.ServiceType = void 0;
...
class DXScannerCommand {
    static async run() {
        ...
        cmder
            ...
            logfile_1.enableLogfile();
            logfile_1.logfile.log(`DX Scanner execution log\nLocal time: ${new Date().toLocaleTimeString()}\nUTC: ${new Date().toUTCString()}\n`);
        })
            .on('--help', () => {
            console.log('');
            console.log('Aliases:');
...
DXScannerCommand.validateFailInput = (value) => {
    if (value && !lodash_1.default.includes(model_1.PracticeImpact, value)) {
        utils_1.debugLog('error')(`Invalid value for --fail: ${value}\nValid values are: ${Object.keys(model_1.PracticeImpact).concat('all').join(', ')}\n`);
        process.exit(1);
    }
    return value;
};
