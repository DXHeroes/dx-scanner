...
const d = utils_1.debugLog('cli:services:git:bitbucket-service');
let BitbucketService = class BitbucketService {
    constructor(argumentsProvider, repositoryConfig) {
        ...
        this.debugBitbucketResponse = (response) => {
            this.callCount++;
            d(colors_1.grey(`Bitbucket API Hit: ${this.callCount}. Remaining ${response.headers['x-ratelimit-remaining']} hits. (${response.headers.link})`));
        };
        ...
        this.extractNameFromString = (text) => {
            if (!text)
                return 'Unkonwn';
    ...
    async listRepoCommits(owner, repo, options) {
        ...
        const items = response.data.values.map((val) => {
            ...
            return {
                ...
                message: val.message,
                author: {
                    name: ((_b = (_a = val.author) === null || _a === void 0 ? void 0 : _a.user) === null || _b === void 0 ? void 0 : _b.nickname) || this.extractNameFromString(val.author.raw),
                    email: this.extractEmailFromString(val.author.raw) || '',
                    date: val.date,
                },
                tree: {
        ...
        return (commits
            ...
            return {
                user: {
                    ...
                    login: ((_h = (_g = commit.author) === null || _g === void 0 ? void 0 : _g.user) === null || _h === void 0 ? void 0 : _h.nickname) || this.extractNameFromString((_j = commit.author) === null || _j === void 0 ? void 0 : _j.raw),
                },
    ...
    unwrap(clientPromise) {
        return clientPromise
            ...
            .catch((error) => {
            if (error.response) {
                d(`${error.response.status} => ${util_1.inspect(error.response.data)}`);
            }
            else {
                d(util_1.inspect(error));
            }
            throw error;
        });
    }
