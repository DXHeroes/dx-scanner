...
exports.listPullRequestsResponse = void 0;
exports.listPullRequestsResponse = (items, pagination) => {
    const defaultItems = [
        {
            user: {
                id: '4087042',
...
//# sourceMappingURL=listPullRequestsResponse.js.map