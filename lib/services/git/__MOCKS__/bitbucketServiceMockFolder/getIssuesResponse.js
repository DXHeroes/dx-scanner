...
exports.getIssuesResponse = void 0;
exports.getIssuesResponse = (items) => {
    const defaultItems = [
        {
            user: {
...
//# sourceMappingURL=getIssuesResponse.js.map