...
exports.getRepoCommitsResponse = void 0;
const gitHubNock_1 = require("../../../../test/helpers/gitHubNock");
exports.getRepoCommitsResponse = [
    {
        ...
        author: new gitHubNock_1.UserItem('583231', 'octocat'),
        committer: new gitHubNock_1.UserItem('583231', 'octocat'),
        parents: [
            {
    ...
    },
    {
        ...
        committer: new gitHubNock_1.UserItem('251370', 'Spaceghost'),
        parents: [
            {
                sha: '553c2077f0edc3d5dc5d17262f6aa498e69d6f8e',
                url: 'https://api.github.com/repos/octocat/Hello-World/commits/553c2077f0edc3d5dc5d17262f6aa498e69d6f8e',
...
//# sourceMappingURL=getRepoCommitsResponse.mock.js.map