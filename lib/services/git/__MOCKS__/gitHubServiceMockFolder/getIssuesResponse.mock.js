...
exports.getIssuesResponse = [
    {
        ...
        number: 513,
        title: 'a',
        user: new gitHubNock_1.UserItem('33818943', 'nowaygod'),
        labels: [],
        state: 'open',
        locked: false,
        assignee: null,
    ...
    {
        headers: {
            link: '<https://api.github.com/repositories/1296269/issues?page=2>; rel="next", <https://api.github.com/repositories/1296269/issues?page=12>; rel="last"',
        },
        ...
        number: 512,
        title: 'Update README',
        user: new gitHubNock_1.UserItem('50170747', 'nmonmontmon'),
        labels: [],
        state: 'open',
        locked: false,
        assignee: null,
...
//# sourceMappingURL=getIssuesResponse.mock.js.map