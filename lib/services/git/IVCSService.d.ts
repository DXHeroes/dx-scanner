...
import { Commit, Contributor, ContributorStats, Directory, File, Issue, PullFiles, PullRequest, PullRequestReview, Symlink, CreatedUpdatedPullRequestComment, PullRequestComment, PullCommits, Branch } from './model';
export interface IVCSService {
    ...
    listPullRequests(owner: string, repo: string, options?: ListGetterOptions<{
...
export declare enum VCSServiceType {
    github = "GitHub",
    bitbucket = "Bitbucket",
    gitlab = "GitLab"
}
...
//# sourceMappingURL=IVCSService.d.ts.map