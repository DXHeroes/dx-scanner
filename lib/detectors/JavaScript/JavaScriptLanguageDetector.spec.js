...
const JavaScriptLanguageDetector_1 = require("./JavaScriptLanguageDetector");
...
describe('JavaScriptLanguageDetector', () => {
    ...
    beforeEach(() => {
        ...
        detector = new JavaScriptLanguageDetector_1.JavaScriptLanguageDetector(fileInspector);
    });
    afterEach(async () => {
    ...
    it('detects javascript correctly via package.json', async () => {
        ...
        expect(langAtPath[0].language).toEqual(model_1.ProgrammingLanguage.JavaScript);
    ...
    it('detects typescript correctly via ts file', async () => {
        ...
        const langAtPath = await detector.detectLanguage();
        expect(langAtPath.length).toEqual(1);
        expect(langAtPath[0].language).toEqual(model_1.ProgrammingLanguage.TypeScript);
        expect(langAtPath[0].path).toEqual(nodePath.sep);
    });
...
//# sourceMappingURL=JavaScriptLanguageDetector.spec.js.map