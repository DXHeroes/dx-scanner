...
const GoLanguageDetector_1 = require("./GoLanguageDetector");
describe('GoLanguageDetector', () => {
    ...
    beforeEach(() => {
        ...
        detector = new GoLanguageDetector_1.GoLanguageDetector(fileInspector);
    });
    afterEach(async () => {
    ...
    it('detects golang correctly via Gopkg.toml', async () => {
        ...
        expect(langAtPath[0].language).toEqual(model_1.ProgrammingLanguage.Go);
...
//# sourceMappingURL=GoLanguageDetector.spec.js.map