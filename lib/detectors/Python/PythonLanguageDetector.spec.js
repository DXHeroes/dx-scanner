...
const PythonLanguageDetector_1 = require("./PythonLanguageDetector");
...
describe('PythonLanguageDetector', () => {
    ...
    beforeEach(() => {
        ...
        detector = new PythonLanguageDetector_1.PythonLanguageDetector(fileInspector);
    });
    afterEach(async () => {
    ...
    it('detects python correctly via requirements.txt', async () => {
        ...
        expect(langAtPath[0].language).toEqual(model_1.ProgrammingLanguage.Python);
...
//# sourceMappingURL=PythonLanguageDetector.spec.js.map