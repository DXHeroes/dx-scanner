...
const CppLanguageDetector_1 = require("./CppLanguageDetector");
describe('CppLanguageDetector', () => {
    ...
    beforeEach(() => {
        ...
        detector = new CppLanguageDetector_1.CppLanguageDetector(fileInspector);
    });
    afterEach(async () => {
    ...
    it('detects cpp correctly via cpp file', async () => {
        ...
        expect(langAtPath[0].language).toEqual(model_1.ProgrammingLanguage.CPlusPlus);
...
//# sourceMappingURL=CppLanguageDetector.spec.js.map