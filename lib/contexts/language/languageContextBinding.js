...
const RustPackageInspector_1 = require("../../inspectors/package/RustPackageInspector");
const detectors_1 = require("../../detectors");
const RustComponentDetector_1 = require("../../detectors/Rust/RustComponentDetector");
...
const createLanguageContainer = (languageAtPath, rootContainer) => {
    ...
    if (scanningStrategy.accessType === detectors_1.AccessType.public || (scanningStrategy.accessType === detectors_1.AccessType.private && args.auth)) {
...
const bindPackageInspectors = (languageAtPath, container) => {
    ...
    else if (languageAtPath.language === model_1.ProgrammingLanguage.Rust) {
        resolveBindingPackageInspector(RustPackageInspector_1.RustPackageInspector, container);
    }
};
...
const componentGenerator = function* () {
    ...
    yield { componentDetector: RustComponentDetector_1.RustComponentDetector, detectedLanguage: model_1.ProgrammingLanguage.Rust };
    return;
};
