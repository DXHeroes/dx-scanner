...
const RubyPackageInspector_1 = require("./RubyPackageInspector");
const GemfileContents_mock_1 = require("../../detectors/__MOCKS__/Ruby/GemfileContents.mock");
describe('RubyPackageInspector', () => {
    let inspector;
    let containerCtx;
    beforeAll(() => {
        containerCtx = inversify_config_1.createTestContainer();
        containerCtx.container.bind('RubyPackageInspector').to(RubyPackageInspector_1.RubyPackageInspector);
        inspector = containerCtx.container.get('RubyPackageInspector');
    });
    beforeEach(async () => {
        containerCtx.container.rebind('RubyPackageInspector').to(RubyPackageInspector_1.RubyPackageInspector);
        inspector = containerCtx.container.get('RubyPackageInspector');
        containerCtx.virtualFileSystemService.setFileSystem({
            Gemfile: GemfileContents_mock_1.gemfileContents,
        });
    });
    afterEach(async () => {
...
//# sourceMappingURL=RubyPackageInspector.spec.js.map