...
const GoPackageInspector_1 = require("./GoPackageInspector");
const inversify_config_1 = require("../../inversify.config");
const goModContents_mock_1 = require("../../detectors/__MOCKS__/Go/goModContents.mock");
describe('GoPackageInspector go.mod', () => {
    let inspector;
    let containerCtx;
    beforeAll(() => {
        containerCtx = inversify_config_1.createTestContainer();
        containerCtx.container.bind('GoPackageInspector').to(GoPackageInspector_1.GoPackageInspector);
        inspector = containerCtx.container.get('GoPackageInspector');
    });
    beforeEach(async () => {
        containerCtx.container.rebind('GoPackageInspector').to(GoPackageInspector_1.GoPackageInspector);
        inspector = containerCtx.container.get('GoPackageInspector');
        containerCtx.virtualFileSystemService.setFileSystem({
            'go.mod': goModContents_mock_1.goModContents,
        });
    });
    afterEach(async () => {
...
//# sourceMappingURL=GoPackageInspector.spec.js.map