...
describe('DoesPullRequests', () => {
    ...
    it('throw error if there is no collaborationInspector', async () => {
        ...
        await expect(practice.evaluate(containerCtx.practiceContext)).rejects.toThrow('You probably provided bad acess token to your repository or did not provided at all.');
    });
});
