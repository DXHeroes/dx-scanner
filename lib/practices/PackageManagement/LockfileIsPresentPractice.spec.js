...
const LockfileIsPresentPractice_1 = require("./LockfileIsPresentPractice");
...
describe('LockfileIsPresentPractice', () => {
    ...
    beforeAll(() => {
        ...
        containerCtx.container.bind('LockfileIsPresentPractice').to(LockfileIsPresentPractice_1.LockfileIsPresentPractice);
...
//# sourceMappingURL=LockfileIsPresentPractice.spec.js.map