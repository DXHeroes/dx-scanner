...
//   getPulls(pulls: { number: number; state: string }[]): PullRequestItem[] {
...
export const getPullRequestsResponse = { items: [], totalCount: 0, hasNextPage: false, hasPreviousPage: false, page: 1, perPage: 0 };
