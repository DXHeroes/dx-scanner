...
export const getOpenPullRequestsResponse: Paginated<PullRequest> = {
  items: [
    {
      user: {
...
export const getMergedPullRequestsResponse: Paginated<PullRequest> = {
  items: [
    {
      user: {
        id: '{9d65d517-4898-47ac-9d2f-fd902d25d9f6}',
...
export const getAllPullrequestsResponse: Paginated<PullRequest> = {
  items: [
    {
      user: {
        id: '{9d65d517-4898-47ac-9d2f-fd902d25d9f6}',
